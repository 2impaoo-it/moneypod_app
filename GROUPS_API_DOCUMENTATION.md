...
## 4️⃣ Thêm Thành Viên Vào Nhóm (Add Member)

**Endpoint:** `POST /groups/:group_id/members`

**Công dụng:** Leader thêm thành viên mới vào nhóm bằng email
...
```json
{
  "error": "Email không tồn tại hoặc đã tham gia nhóm"
}
```

---

## 5️⃣ Tạo Chi Tiêu Trong Nhóm
...
## 6️⃣ Xem Lịch Sử Chi Tiêu Của Nhóm
